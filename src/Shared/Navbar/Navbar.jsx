  ...
  const NavbarMenus = (
    <>
      <li className="py-1 lg:py-0">
        <NavLink className="uppercase" to="/employees">
          Employees
        </NavLink>
      </li>
      <li className="py-1 lg:py-0">
        ...
        <div className="navbar py-3 container mx-auto">
          <div className="navbar-start">
            <div className="dropdown">
              ...
              <ul
                tabIndex="0"
                className="menu menu-compact dropdown-content mt-4 p-2 shadow-xl bg-base-100 rounded-box w-60 border"
              >
                {NavbarMenus}
                {/* {!user && (
            ...
            <div className="flex justify-center items-center">
              <Link to="/" className="inline-flex items-center mr-8">
                {/* {!user ? (
                  ...
                  <img
                    src="https://raw.githubusercontent.com/thkSoftwares/mongoose-starter/main/views/ts-node.svg"
                    alt=""
                    className="ml-[6rem] md:ml-64 lg:ml-0 w-10 lg:w-12"
                  />
                {/* )} */}
              </Link>
            </div>
